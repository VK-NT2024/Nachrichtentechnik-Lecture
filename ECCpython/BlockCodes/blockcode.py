...
class BlockCode:
    ...
    def cosets(self):
        ...
        try: 
            ...
            coset_leaders = {}
            for t_val in range(1,self.t+1):
                for combination in combinations(range(self.n), t_val):
                ...
                coset_leaders[0] = 0
            self._coset_leaders = coset_leaders
            return self._coset_leaders
    ...
    def encode(self, u):
        ...
        input:
            u:  2D array of
                information bits -> each column will be coded to one codeword
    ...
    def encode_array(self, u):
        ...
        try:
            ...
            raise ValueError(
                f"number of columns of u needs to be a multiple of {self.k} but input has {np.shape(u)[1]} columns")
