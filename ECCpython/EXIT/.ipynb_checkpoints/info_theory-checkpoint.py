...
def mi_awgn(x,pmf_x,snrdB=None,noiseVar=None,N=1000):
    ...
    snrdB: signal-to-noise-ratio in dB per real dimension
            for real-valued alphabets, imaginary noise part is obsolete (SNR is twice that of complex-valued alphabets)
            real Gaussian distribution uses 0.5 * 2 sigma2N = sigma2N in exponent
